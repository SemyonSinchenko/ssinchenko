...
[[https://en.wikipedia.org/wiki/PageRank][What is PageRank?]]


The task is to compute PageRank on ~graph500-26~ from [[https://ldbcouncil.org/benchmarks/graphalytics/datasets/][Graphalytics dataset]]:
...
[[https://en.wikipedia.org/wiki/Weak_component][What are Weakly Components?]]
...
1. Pregel main loop: [[https://github.com/SemyonSinchenko/graphframes-rs/blob/main/src/algorithm/pregel.rs][pregel.rs]]
2. WCC implementation: [[https://github.com/SemyonSinchenko/graphframes-rs/blob/main/src/algorithm/connectivity/connected_components.rs][connected_components.rs]]

To understand the Pregel notation this can be very useful source: [[https://web.stanford.edu/~rezab/classes/cme323/S15/notes/lec8.pdf][Lecture 8, CME 323: Distributed Algorithms and Optimization]]

{{< figure src="/ssinchenko/images/pregel-viz.png" alt="The Pregel paradigm’s data flow model" width="400px" align="center" >}}

An example of PageRank using the API: [[https://github.com/SemyonSinchenko/graphframes-rs/blob/main/src/algorithm/centrality/pagerank.rs][pagerank.rs]]
